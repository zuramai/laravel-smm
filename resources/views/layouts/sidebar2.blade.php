                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ url('/developer') }}" class="waves-effect">
                                    ...
                                    <span> Halaman Developer</span>
                                </a>
                            </li>
                            @endif
                            @if(Auth::user()->level != 'Member')
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-lock"></i> <span> {{ auth()->user()->level }} Menu</span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-cart"></i> <span> Sosial Media </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-document"></i><span> Lainnya </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-graph-bar"></i><span> Deposit Saldo </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li>
                                <a href="{{ url('ticket') }}" class="waves-effect"><i class="dripicons-calendar"></i><span> Tiket Bantuan </span></a>
                            </li>



                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-view-thumb"></i><span> Daftar Layanan </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-view-thumb"></i><span> API Dokumentasi </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li><a href="{{ url('/contact') }}" class="nav-link"><i class="dripicons-user"></i><span>Kontak Staff</span></a></li>
                            @auth
