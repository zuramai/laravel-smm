                ...
                <div class="block">
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('license') ? ' has-error ' : '' }}">
                            <label for="broadcast_driver">Your License
                                <sup>
                                    <a href="#" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>
                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                            </label>
                            <input type="text" name="license" id="broadcast_driver" value="" placeholder="Insert your license here" />
